...
export const PALETTES: Record<PaletteKey, PaletteEntry> = {
  ...
  emerald: {
    ...
    light: {
      ...
      micIcon: '#121A16', micLabel: '#29332E', tabBg: '#ECFDF5',
  ...
  gold: {
    ...
    light: {
      ...
      micIcon: '#1F1E1B', micLabel: '#44423C', tabBg: '#FFFEE0',
  ...
  amber: {
    ...
    light: {
      ...
      micIcon: '#1F1F1E', micLabel: '#44403C', tabBg: '#FFFBEB',
  ...
  calmBlue: {
    ...
    light: {
      ...
      micIcon: '#1F2422', micLabel: '#3F4442', tabBg: '#F1F6F4',
  ...
  deepOcean: {
    ...
    light: {
      ...
      micIcon: '#111E24', micLabel: '#243842', tabBg: '#EBF5FA',
  ...
  clearSky: {
    ...
    light: {
      ...
      micIcon: '#131B22', micLabel: '#263543', tabBg: '#EFF6FC',
  ...
  slateNavy: {
    ...
    light: {
      ...
      micIcon: '#141922', micLabel: '#28334A', tabBg: '#EDF0F5',
      tabBorder: '#1C2330', tabInactive: '#56697F',
    },
