...
- #식단: **치료적 식이요법/제한식/특수 프로토콜만**. GFCF, 갭스, GAPS, 저포드맵, 글루텐 제한, 카제인 제한
  ✗ 일반 식사 기록은 #식사 사용 (#식단 아님)
- #식사: **일반 식사 행위**. 아침/점심/저녁/간식, 메뉴, 식사량, 음식 선호 등 치료적 의도 없는 식사 기록 전부.
  ✓ "오늘 김치찌개 먹음", "간식 많이 먹음", "저녁에 밥 안 먹음"
  ✗ 음식 후 신체 반응(트림/구토/복통)은 #건강
  ✗ 치료식(GFCF 등)은 #식단
- #일상: 위 태그에 해당하지 않는 일반 일상 케어 (외출·놀이·등하원 등)
${customTagSection}
...
- behavioral_incident이면 tags의 첫 번째가 반드시 "#행동"일 것.
  ❌ ["#기분", "#자해"]
  ✓ ["#행동", "#기분", "#자해"]
- 일반 식사 기록은 #식단이 아니라 #식사.
  ❌ "저녁 메뉴는 김치찌개" → ["#식단"] 또는 ["#일상"]
  ✓ "저녁 메뉴는 김치찌개" → ["#식사"]
...
JSON 응답 예시 (일반 식사):
{"summary": "저녁으로 김치찌개 먹음. 두 그릇 먹음.", "tags": ["#식사"], "structured_data": {"event_type": "daily"}}

JSON 응답 예시 (식사 후 신체 반응 — 음식 인과):
{"summary": "저녁에 장어 먹은 후 차 안에서 트림을 계속함. 장어 때문인지 불확실.", "tags": ["#식사", "#건강"], "structured_data": {"event_type": "daily"}}
...
경계 규칙:
- #식단: 치료적 식이요법만(GFCF·GAPS·저포드맵 등). 일반 식사는 #식사.
- #식사: 일반 식사 행위(아침/점심/저녁/간식·메뉴·식사량·선호). 치료적 의도 없는 식사 전부.
- #의료: 의료인(의사/간호사) 직접 개입 시만. 가정 내 처치/단독 투약은 #건강 또는 #투약.
- #건강: 의료인 개입 없는 신체/질병 (감기, 가정 내 상처/멍, 음식 후 신체 반응 등).
${customTagSection}
응답 형식: {"tags": ["#태그1", "#태그2"]}`;
}
